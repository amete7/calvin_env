...
def main(cfg):
    ...
    if save_video:
        output_video_path = 'train_output_video.mp4'
        frame_size = (400,400)
        fps = 15
    ...
    indices = torch.tensor([803, 803, 803, 803, 803, 803, 803, 803, 803, 803, 803, 803, 603, 602,
         764, 764, 764, 764, 764, 764, 764, 764, 764, 764, 763, 763, 763, 763,
         763, 763, 763, 963]).to(device)
