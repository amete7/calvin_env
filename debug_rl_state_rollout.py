...
import sys
import collections
from utils import top_k_sampling, top_p_sampling, greedy_sampling, get_top_k_probs
sys.path.append('/home/amete7/diffusion_dynamics/diff_skill/code')
from model_v3 import SkillAutoEncoder
from gpt_prior_dt import GPT, GPTConfig
...
def main(cfg):
    ...
    model = nn.DataParallel(SkillAutoEncoder(cfg.model))
...
if __name__== "__main__":
    ...
    with initialize(config_path="conf"):
        # print("config path:")
        cfg = compose(config_name="config_data_collection_rl_state.yaml", overrides=["cameras=static_and_gripper"])
